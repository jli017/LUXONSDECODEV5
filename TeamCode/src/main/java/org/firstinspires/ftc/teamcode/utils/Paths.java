...
public class Paths {
    ...
    public Paths(Follower follower, Lebruxon.Alliance alliance) {
        ...
        if (alliance == Lebruxon.Alliance.RED || alliance == Lebruxon.Alliance.REDCLOSE) {
            ...
            intakegpp1Pose             = intakegpp1Pose.mirror();
            intakegpp2Pose             = intakegpp2Pose.mirror();
            shootgppPose               = shootgppPose.mirror();
            intakepgp1Pose             = intakepgp1Pose.mirror();
            ...
            CloseIntakeG1Pose     = CloseIntakeG1Pose.mirror();
            CloseIntakeG3Pose     = CloseIntakeG3Pose.mirror();
            CloseIntakeG1Pose2    = CloseIntakeG1Pose2.mirror();
            CloseIntakeG3Pose2    = CloseIntakeG3Pose2.mirror();
        ...
        intakeGPP1 = follower.pathBuilder()
                .addPath(new BezierLine(shootingPose, intakeGPP1Pose))
                .setLinearHeadingInterpolation(shootingPose.getHeading(), intakeGPP1Pose.getHeading())
                .setBrakingStrength(0.42)
                .build();

        intakeGPP2 = follower.pathBuilder()
                .addPath(new BezierLine(intakeGPP1Pose, intakeGPP2Pose))
                .setLinearHeadingInterpolation(intakeGPP1Pose.getHeading(), intakeGPP2Pose.getHeading())
                .setBrakingStrength(0.42)
                .build();

        scoreGPP = follower.pathBuilder()
                .addPath(new BezierLine(intakeGPP2Pose, shootingPose))
                .setLinearHeadingInterpolation(intakeGPP2Pose.getHeading(), shootingPose.getHeading())
                .setBrakingStrength(0.42)
                .build();

        intakePGP1 = follower.pathBuilder()
                .addPath(new BezierLine(shootingPose, intakePGP1Pose))
                .setLinearHeadingInterpolation(shootingPose.getHeading(), intakePGP1Pose.getHeading())
                .setBrakingStrength(0.42)
                .build();

        intakePGP2 = follower.pathBuilder()
                .addPath(new BezierLine(intakePGP1Pose, intakePGP2Pose))
                .setLinearHeadingInterpolation(intakePGP1Pose.getHeading(), intakePGP2Pose.getHeading())
                .setBrakingStrength(0.42)
                .build();

        scorePGP = follower.pathBuilder()
                .addPath(new BezierCurve(intakePGP2Pose, scorePGPControl, shootingPose))
        ...
        intakePPG2 = follower.pathBuilder()
                .addPath(new BezierLine(intakePPG1Pose, intakePPG2Pose))
                .setLinearHeadingInterpolation(intakePPG1Pose.getHeading(), intakePPG2Pose.getHeading())
                .setBrakingStrength(0.42)
                .build();

        scorePPG = follower.pathBuilder()
                .addPath(new BezierCurve(intakePPG2Pose, scorePGPControl, shootingPose))
                .setBrakingStrength(0.42)
        ...
        intakegpp1 = follower.pathBuilder()
                .addPath(new BezierLine(shootPose, intakegpp1Pose))
        ...
        shootgpp = follower.pathBuilder()
                .addPath(new BezierLine(intakegpp2Pose, shootPose))
                .setLinearHeadingInterpolation(intakegpp2Pose.getHeading(), shootPose.getHeading())
                .setBrakingStrength(0.42)
                .build();

        intakepgp1 = follower.pathBuilder()
                .addPath(new BezierLine(shootPose, intakepgp1Pose))
                .setLinearHeadingInterpolation(shootPose.getHeading(), intakepgp1Pose.getHeading())
                .setBrakingStrength(0.42)
                .build();

        checkIntakepgp1 = follower.pathBuilder()
                .addPath(new BezierLine(intakepgp1Pose, checkBackintakepgp1Pose))
                .setLinearHeadingInterpolation(intakepgp1Pose.getHeading(), checkBackintakepgp1Pose.getHeading())
                .setBrakingStrength(0.42)
                .build();

        intakepgp1again = follower.pathBuilder()
                .addPath(new BezierLine(checkBackintakepgp1Pose, intakepgp1Pose))
        ...
        gatePickup = follower.pathBuilder()
                .addPath(new BezierLine(shootPose, gateToPick))
                .setLinearHeadingInterpolation(shootPose.getHeading(), gateToPick.getHeading())
                .setBrakingStrength(0.42)
                .build();

        gateCheckBack = follower.pathBuilder()
                .addPath(new BezierLine(gateToPick, gateCheck))
                .setLinearHeadingInterpolation(gateToPick.getHeading(), gateCheck.getHeading())
                .setBrakingStrength(0.42)
                .build();

        gateCheckForward = follower.pathBuilder()
                .addPath(new BezierLine(gateCheck, gateToPick))
                .setLinearHeadingInterpolation(gateCheck.getHeading(), gateToPick.getHeading())
                .setBrakingStrength(0.42)
                .build();

        shootGateCheck = follower.pathBuilder()
                .addPath(new BezierLine(gateToPick, shootPose))
        ...
        ClosestartToScore = follower.pathBuilder()
        ...
        CloseintakePPG = follower.pathBuilder()
        ...
        ClosescorePPG = follower.pathBuilder()
        ...
        CloseintakePGP1 = follower.pathBuilder()
        ...
        ClosescorePGP = follower.pathBuilder()
        ...
        CloseIntakeG1 = follower.pathBuilder()
        ...
        CloseIntakeG3 = follower.pathBuilder()
        ...
        CloseIntakeG12 = follower.pathBuilder()
        ...
        CloseIntakeTurn = follower.pathBuilder()
                .addPath(new BezierLine(CloseIntakeG1Pose, CloseIntakeG1Pose2))
                .setLinearHeadingInterpolation(CloseIntakeG1Pose.getHeading(), CloseIntakeG1Pose2.getHeading())
                .build();

        CloseIntakeTurn3 = follower.pathBuilder()
        ...
        CloseintakeGPP2 = follower.pathBuilder()
        ...
        Closeintakelast = follower.pathBuilder()
        ...
        Closescorefinal = follower.pathBuilder()
